...
def the_model() -> Model:
    ...
    nr_of_boxes = range(1, 3),  # 2 boxes
    nr_of_poses = range(1, 3),  # 2 poses per box
    nr_of_objects = range(1, 3)  # 2 objects

    ops = {}

    for i in nr_of_objects:
        for j in nr_of_boxes:
    ...
    for i in nr_of_objects:
        for j in nr_of_poses:
            for k in nr_of_boxes:
